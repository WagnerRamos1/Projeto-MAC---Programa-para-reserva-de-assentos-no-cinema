...
import Funções
sala_1, cadeiras_sala1 = Funções.criar_sala_cinema(6, 6)
sala_2, cadeiras_sala2 = Funções.criar_sala_cinema(6, 6)
sala_3, cadeiras_sala3 = Funções.criar_sala_cinema(6, 6)
while True:
